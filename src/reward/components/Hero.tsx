...
export const Hero = React.memo(() => {
    return (
        <section className="custom-width flex flex-col-reverse gap-2 py-10 text-center lg:flex-row">
            <article className="flex flex-1 flex-col justify-center gap-4 text-left">
                <h1 className="px-2 font-mono text-5xl font-bold leading-tight">
                    Reward
                </h1>

                <p className="max-w-md px-2 text-xl text-gray-400">
